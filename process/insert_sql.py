...
class SQL():
    ...
    def insert(myc):
        ...
        #mycursor.execute("CREATE TABLE %s (CNPJ VARCHAR(255), RAZAO_SOCIAL VARCHAR(255), NAT_JUT VARCHAR(255), QUALI VARCHAR(255), PORT VARCHAR(255) )" %(myc.table_emprecsv))
       # mycursor.execute("CREATE TABLE %s (CNPJ VARCHAR(255), ORDEM VARCHAR(255), DV VARCHAR(255), ID VARCHAR(255), FANTASIA VARCHAR(255), SIT_CAD VARCHAR(255), DAT_SIT VARCHAR(255), INICIO VARCHAR(255), CNAE_P VARCHAR(255), CEP VARCHAR(255), UF VARCHAR(255), MUN VARCHAR(255) )" %(myc.table_estabelecsv))
